export const knowledgeBase = [
  ...
  },
  {
    ...
    acpResponse:
      "The overall price is $0 as it is a free of cost upgrade we are offering to commercial customers, howevr there has been some clerical error in the list of sites.",
    auditorNotes: "Finding and recommendation",
  },
  {
    issuesIdentified:
  ...
  },
  {
    ...
    acpResponse:
      "Uniform signature is updated in the job. After each job the installers are required to provide their signature in dataforce, and fron that the forms gets updated, hence the discrepancy.",
    auditorNotes: "Observation and recommendation to be consistent",
  },
  {
    issuesIdentified:
  ...
  },
  {
    ...
    acpResponse:
      "The actaul implemantation datwe is as mentioned on the list of site, 26/05/2023, however due to some technical error in the backend the forms have picked up a different date",
    auditorNotes:
      "Finding and recommendation  - nom. form signed 26/05/2023, however some documents listed implementation date prior, however MYOM confirmed 26/05/2023 is the actual implementatio date. GTP shows 26/05/2023",
  },
  {
    issuesIdentified:
    ...
    acpResponse:
      "208386: Images showing the old tank has been disconnected and hole rendered has been provided. \n209045: It is a straight swap.\nConfirmation from customer confirming the old unit has been removed ihave been added in the evidnce pack supplied",
    auditorNotes: "No issues",
  },
  {
    issuesIdentified:
  ...
  },
  {
    ...
    acpResponse:
      "The job is a straight swap, new tank is located exactly where the old tank was located. We tried reaching out to the customer for a phone confirmation but were not successful. However, the image of the decomissioned tank which shows its inoperable with a hole drilled in it has been added to the evidence pack",
    auditorNotes: "No issues",
  },
  {
    issuesIdentified:
      'The auditor noted that the Site Assessment Report provided is by "Demand Manager". Please clarify.',
    acpResponse:
      "Demand Manager is one of our agent,unfortunately due to some dataforce glitch the forms were updated under their name. The issue has been rectified.",
    auditorNotes:
      "A - logo is Demand Manager, however MYOM is listed as the company name",
  },
  {
    issuesIdentified:
      "The auditor noted that `Justin Paul Reeves'` signature with inconsistent across forms - CoC had a different signature as opposed to tax invoice, site assessment report and installer declaration. Please clarify.",
    acpResponse:
      "Uniform signature is updated in the job. After each job the installers are required to provide their signature in dataforce, and fron that the forms gets updated, hence the discrepancy.",
    auditorNotes: "Observation and recommendation to be consistent",
  },
  {
    issuesIdentified:
      "The auditor noted that the nameplate of the existing heat pump water heater has been removed. Please provide an image that clearly shows the nameplate.",
    acpResponse:
      "Unfortunately the specs plate of the tank was ripped off when we visited the property. Basis the dimensions of the tank, it is 315L having 3.6kW rating (manufacturedr;s brochure for the product added). Also, we have taken the heating element image showing the kW rating, please consider.",
    auditorNotes: "No issues",
  },
  {
    issuesIdentified:
      "The auditor noted that installer declaration lists a different water heater that is noted in CoC and Tax Invoice.\n\nCoC: MHW-F26WN3/MT-300R26E20\nTax Invoice: MHW-F26WN3-300R26E20\nInstaller Declaration: HPC026/MT-200R26E20\n\nPlease clarify.",
    acpResponse: "Clerical error.Job updated with correct details",
    auditorNotes:
      "Observation - HPC026 and MHW-F26WN3 are the same product, refer to the manfuacturer email confirmation",
  },
];
