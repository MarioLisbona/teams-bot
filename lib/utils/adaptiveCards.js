    ...
    body: [
      {
        ...
        items: [
          ...
          {
            type: "TextBlock",
            text: "Prepend any Agent prompts with **@els-test-bot**",
            wrap: true,
            spacing: "medium",
            isSubtle: true,
            style: "default",
          ...
          {
            type: "TextBlock",
            text: "To trigger the RFI Processing Agent, use a command similar to the one below:",
            wrap: true,
            spacing: "small",
          },
          {
            type: "TextBlock",
            text: "`@els-test-bot Process RFI for <filename>`",
            wrap: true,
            spacing: "small",
            fontType: "monospace",
          },
          {
            type: "TextBlock",
            text: "Example: @els-test-bot Process the rfi data in XXYY Testing",
            wrap: true,
            spacing: "small",
          },
          {
            type: "TextBlock",
            text: "Auditor Notes Agent",
            size: "medium",
            weight: "bolder",
            color: "accent",
            spacing: "medium",
          ...
          {
            type: "TextBlock",
            text: "To trigger the Auditor Notes Agent, use a command similar to the one below:",
            wrap: true,
            spacing: "small",
          },
          {
            type: "TextBlock",
            text: "`@els-test-bot Generate auditor notes for <filename>`",
            wrap: true,
            spacing: "small",
            fontType: "monospace",
          },
          {
            type: "TextBlock",
            text: "Example: @els-test-bot Generate auditor notes for RFI Responses - MLD",
            wrap: true,
            spacing: "small",
          },
        ],
 ...
 * @param {string} [fileUrl=""] - Optional SharePoint file URL
 *
 * @returns {Object} Adaptive card JSON structure with:
 * - Card type and version information
 ...
 */
export const createTeamsUpdateCard = (
  text,
  userMessage,
  emoji,
  style,
  ...
  // Add button only if we have a URL
  if (fileUrl && fileUrl.trim().length > 0) {
    ...
    cardBody[0].items.push(actionSet);
  }
...
export const createHumanValidationStepsCard = (
  ...
  // Create the validation items array
