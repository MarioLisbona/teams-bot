...
export function createReviewImagesCard(message, images) {
  const reviewCard = {
    type: "AdaptiveCard",
    version: "1.0",
    body: [
...
export function createTeamsUpdateCard(text, emoji, style) {
  const teamsUpdateCard = {
    type: "AdaptiveCard",
    version: "1.0",
    body: [
      {
  ...
  return teamsUpdateCard;
}

export function createWorkflowProgressCard(jobId, workflowStep, isCompleted) {
  return {
    type: "AdaptiveCard",
    version: "1.0",
    body: [
