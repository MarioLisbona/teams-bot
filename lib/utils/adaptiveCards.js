...
export const createValidationProgressCard = (validationType) => {
  return {
    type: "AdaptiveCard",
    version: "1.0",
    body: [
      {
        ...
        items: [
          {
            type: "TextBlock",
            text: `🔄 Processing validation for Step ${validationType}`,
            size: "medium",
            weight: "bolder",
          },
          {
            type: "TextBlock",
            text: "Please wait while validation is in progress...",
            wrap: true,
          },
        ],
      },
...
export const createValidationCompletionCard = (validationType) => {
  return {
    type: "AdaptiveCard",
    version: "1.0",
    body: [
      {
        ...
        items: [
          {
            type: "TextBlock",
            text: `✅ Validation Complete for Step ${validationType}`,
            size: "medium",
            weight: "bolder",
            color: "good",
          },
...
export const createHumanWorkflowValidationCard = (
  validationsRequired,
