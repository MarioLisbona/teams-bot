  ...
  if (context.activity.type === "message") {
    ...
    switch (action || userMessage) {
      ...
      case "validate":
        ...
        // Send a simple card showing validation in progress
        const validationMessageCard = await context.sendActivity({
          attachments: [
            {
              contentType: "application/vnd.microsoft.card.adaptive",
              content: {
        ...
        // Update the validation message card to show completion
        await context.updateActivity({
          type: "message",
          id: validationMessageCard.id,
          attachments: [
            {
              contentType: "application/vnd.microsoft.card.adaptive",
              content: {
