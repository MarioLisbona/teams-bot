...
import { handleTeamsActivity } from "../utils/errorHandling.js";

// Handle messages from the bot
export async function handleMessages(adapter, context) {
  // Log the activity type for debugging
  console.log(`Received activity type: ${context.activity.type}`);

  // Handle the various activity types sent back to the bot from Teams
