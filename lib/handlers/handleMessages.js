  ...
  try {
    switch (action || userMessage) {
      ...
      case "processTestingActionSelected":
        await handleProcessTestingActionSelected(context, adapter);
        break;

      case "testingWorkbookSelected":
        console.log("testingWorkbookSelected");
        await handleTestingWorkbookSelected(context, adapter);
        break;
      ...
      // Returns the action "processClientResponsesSelected" when the user selects a file
