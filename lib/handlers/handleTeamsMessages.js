...
export async function handleMessages(context) {
  ...
  if (context.activity.type === "message") {
    ...
    switch (action || userMessage) {
      ...
      // User has selected the "Process RFI Worksheet" button from the RFI Actions card
      // Displays the file selection card displaying the Testing worksheets in the client directory
      ...
      // User has selected a clientTesting worksheet from the file selection card
      ...
      // When a file is selected the action "responsesWorkbookSelected" when the user selects a file
      ...
      // Each time the validation button is clicked the action "humanValidation" is triggered
