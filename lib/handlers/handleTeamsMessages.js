      ...
      try {
        switch (action || userMessage) {
          ...
          case "rfiWorksheetSelected":
            console.log("rfiWorksheetSelected");
          ...
          default:
            if (userMessage) {
              if (userMessage.toLowerCase().includes("process")) {
                console.log("Processing message detected");
                await runProcessing(userMessage, context);
              } else if (userMessage.toLowerCase().includes("auditor notes")) {
                await runAuditorNotes(userMessage, context);
              } else {
