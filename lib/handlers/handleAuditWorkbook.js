...
export async function handleRfiClientSelected(context) {
  ...
  // Create the RFI actions card
  // Displays buttons for available RFI actions
  // Return the action "processRfiActionSelected" when the user selects the "Process RFI Worksheet" button
  // Return the action "processResponsesActionSelected" when the user selects the "Process Client Responses" button
