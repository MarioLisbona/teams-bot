...
export async function handleHumanWorkflowValidationUI(
  ...
  const validationCard = createHumanWorkflowValidationCard(validations, jobId);
...
export async function handleHumanValidation(context) {
  ...
  await context.sendActivity({
    attachments: [
      {
        contentType: "application/vnd.microsoft.card.adaptive",
        content: createValidationProgressCard(validationType),
      },
    ],
  });
  ...
  await context.sendActivity({
    attachments: [
      {
        contentType: "application/vnd.microsoft.card.adaptive",
        content: createValidationCompletionCard(validationType),
      },
    ],
  });

  // await createTeamsUpdate(context, "Validation completed", "✅", "good");
