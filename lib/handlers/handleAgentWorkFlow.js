...
export async function handleApproveRejectImages(context) {
  ...
  // Create images card
  const imagesCard = createApproveRejectImagesCard(message, images);
...
export async function handleSubmitImageReview(context) {
  console.log("handleSubmitImageReview function called");
